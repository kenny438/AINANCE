...
interface BussinLogoIconProps extends React.SVGProps<SVGSVGElement> {}

const BussinLogoIcon: React.FC<BussinLogoIconProps> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    >
      BUSSIN<tspan dx="2">💀</tspan>
    </text>
  </svg>
);

export default BussinLogoIcon;
